...
/**
 * UsersourceSettingsApi Class Doc Comment
 *
 * @category Class
 * @package  DeskPRO\API
 * @author   Swagger Codegen team
...
class UsersourceSettingsApi
{
    ...
    /**
     * Operation getSettingUserSourceAsync
     *
     * 
     *
     * Parameters:
    ...
    /**
     * Operation getSettingUserSourceAsyncWithHttpInfo
     *
     * 
     *
     * Parameters:
    ...
    protected function getSettingUserSourceRequest(array $params = [])
    {
        ...
        $resourcePath = '/settings/user_source';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
