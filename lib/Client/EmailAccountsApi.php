...
class EmailAccountsApi
{
    ...
    /**
     * Operation deleteEmailAccountByIdCertificateAsync
     *
     * 
     *
     *
    ...
    /**
     * Operation deleteEmailAccountByIdCertificateAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    protected function deleteEmailAccountByIdCertificateRequest($id)
    {
        ...
        $resourcePath = '/email_accounts/{id}/certificate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation deleteEmailAccountByIdKeyAsync
     *
     * 
     *
     *
    ...
    /**
     * Operation deleteEmailAccountByIdKeyAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    protected function deleteEmailAccountByIdKeyRequest($id)
    {
        ...
        $resourcePath = '/email_accounts/{id}/key';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation setEmailAccountByIdEncryptionAsync
     *
     * 
     *
     *
    ...
    /**
     * Operation setEmailAccountByIdEncryptionAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    protected function setEmailAccountByIdEncryptionRequest($id)
    {
        ...
        $resourcePath = '/email_accounts/{id}/encryption';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
