...
/**
 * TicketFormWidgetApi Class Doc Comment
 *
 * @category Class
 * @package  DeskPRO\API
 * @author   Swagger Codegen team
...
class TicketFormWidgetApi
{
    ...
    /**
     * Operation getTicketFormWidgetCodeAsync
     *
     * 
     *
     *
    ...
    /**
     * Operation getTicketFormWidgetCodeAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    protected function getTicketFormWidgetCodeRequest()
    {
        ...
        $resourcePath = '/ticket-form-widget/code';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
