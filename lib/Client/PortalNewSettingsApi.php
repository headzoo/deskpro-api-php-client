...
/**
 * PortalNewSettingsApi Class Doc Comment
 *
 * @category Class
 * @package  DeskPRO\API
 * @author   Swagger Codegen team
...
class PortalNewSettingsApi
{
    ...
    /**
     * Operation getSettingBrandNewPortalGeneralAsync
     *
     * 
     *
     *
    ...
    /**
     * Operation getSettingBrandNewPortalGeneralAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    protected function getSettingBrandNewPortalGeneralRequest()
    {
        ...
        $resourcePath = '/settings/brands/new/portal/general';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
