...
/**
 * GlossaryWordDefinitionType Class Doc Comment
 *
 * @category Class
 * @package  DeskPRO\API
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GlossaryWordDefinitionType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GlossaryWordDefinitionType';
    ...
    protected static $swaggerTypes = [
        'definition' => 'string',
        'words' => '\DeskPRO\API\Model\GlossaryWordType[]'
    ];
     ...
     * Gets words
     *
     * @return \DeskPRO\API\Model\GlossaryWordType[]
     */
     ...
     * Sets words
     *
     * @param \DeskPRO\API\Model\GlossaryWordType[] $words words
     *
     * @return $this
     */
